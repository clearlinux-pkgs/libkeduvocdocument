...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/libkeduvocdocument-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/libkeduvocdocument-24.08.0.tar.xz.sig
...
%setup -q -n libkeduvocdocument-24.08.0
cd %{_builddir}/libkeduvocdocument-24.08.0
pushd ..
cp -a libkeduvocdocument-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724434891
mkdir -p clr-build
pushd clr-build
