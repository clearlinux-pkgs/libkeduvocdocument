...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkeduvocdocument-22.08.0.tar.xz
...
%prep
%setup -q -n libkeduvocdocument-22.08.0
cd %{_builddir}/libkeduvocdocument-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661533606
mkdir -p clr-build
pushd clr-build
