...
Version  : 23.08.2
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.2/src/libkeduvocdocument-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/libkeduvocdocument-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/libkeduvocdocument-23.08.2.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-23.08.2
cd %{_builddir}/libkeduvocdocument-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697234353
mkdir -p clr-build
pushd clr-build
