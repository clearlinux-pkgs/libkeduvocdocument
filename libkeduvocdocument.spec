...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/libkeduvocdocument-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/libkeduvocdocument-24.12.2.tar.xz.sig
...
%setup -q -n libkeduvocdocument-24.12.2
cd %{_builddir}/libkeduvocdocument-24.12.2
pushd ..
cp -a libkeduvocdocument-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738948660
mkdir -p clr-build
pushd clr-build
