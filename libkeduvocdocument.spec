...
Source0  : https://download.kde.org/stable/applications/19.08.0/src/libkeduvocdocument-19.08.0.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.0/src/libkeduvocdocument-19.08.0.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-19.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565913113
mkdir -p clr-build
pushd clr-build
