...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/libkeduvocdocument-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/libkeduvocdocument-25.04.0.tar.xz.sig
...
%setup -q -n libkeduvocdocument-25.04.0
cd %{_builddir}/libkeduvocdocument-25.04.0
pushd ..
cp -a libkeduvocdocument-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744908425
mkdir -p clr-build
pushd clr-build
