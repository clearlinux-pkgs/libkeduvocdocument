...
Version  : 19.04.0
Release  : 5
URL      : https://download.kde.org/stable/applications/19.04.0/src/libkeduvocdocument-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/libkeduvocdocument-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/libkeduvocdocument-19.04.0.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-19.04.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1555623938
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
