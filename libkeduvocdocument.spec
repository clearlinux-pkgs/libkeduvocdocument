...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/libkeduvocdocument-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/libkeduvocdocument-24.02.1.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-24.02.1
cd %{_builddir}/libkeduvocdocument-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711035967
mkdir -p clr-build
pushd clr-build
