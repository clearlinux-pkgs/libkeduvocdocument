...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libkeduvocdocument-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libkeduvocdocument-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-24.02.0
cd %{_builddir}/libkeduvocdocument-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710378023
mkdir -p clr-build
pushd clr-build
