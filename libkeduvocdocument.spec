...
Version  : 20.04.2
Release  : 20
URL      : https://download.kde.org/stable/release-service/20.04.2/src/libkeduvocdocument-20.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/libkeduvocdocument-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/libkeduvocdocument-20.04.2.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-20.04.2
cd %{_builddir}/libkeduvocdocument-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591891202
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkeduvocdocument-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/libkeduvocdocument/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libkeduvocdocument-20.04.2/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkeduvocdocument/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkeduvocdocument-20.04.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkeduvocdocument/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
