...
Version  : 23.04.2
Release  : 54
URL      : https://download.kde.org/stable/release-service/23.04.2/src/libkeduvocdocument-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/libkeduvocdocument-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/libkeduvocdocument-23.04.2.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-23.04.2
cd %{_builddir}/libkeduvocdocument-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686504238
mkdir -p clr-build
pushd clr-build
