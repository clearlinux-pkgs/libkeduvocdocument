...
Version  : 22.04.1
Release  : 39
URL      : https://download.kde.org/stable/release-service/22.04.1/src/libkeduvocdocument-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/libkeduvocdocument-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/libkeduvocdocument-22.04.1.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-22.04.1
cd %{_builddir}/libkeduvocdocument-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652637044
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkeduvocdocument-22.04.1/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkeduvocdocument/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkeduvocdocument-22.04.1/LICENSES/BSD-1-Clause.txt %{buildroot}/usr/share/package-licenses/libkeduvocdocument/6620eeea6ee5696c0b887850201ba4c607380356
cp %{_builddir}/libkeduvocdocument-22.04.1/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/libkeduvocdocument/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/libkeduvocdocument-22.04.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkeduvocdocument/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
