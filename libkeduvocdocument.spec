...
Source0  : https://download.kde.org/stable/applications/19.08.2/src/libkeduvocdocument-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/libkeduvocdocument-19.08.2.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-19.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570774349
mkdir -p clr-build
pushd clr-build
