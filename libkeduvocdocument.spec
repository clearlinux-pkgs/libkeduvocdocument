...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/libkeduvocdocument-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/libkeduvocdocument-24.12.1.tar.xz.sig
...
%setup -q -n libkeduvocdocument-24.12.1
cd %{_builddir}/libkeduvocdocument-24.12.1
pushd ..
cp -a libkeduvocdocument-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736483721
mkdir -p clr-build
pushd clr-build
