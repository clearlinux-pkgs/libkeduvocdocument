...
Source0  : https://download.kde.org/stable/applications/19.04.2/src/libkeduvocdocument-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/libkeduvocdocument-19.04.2.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-19.04.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1559908019
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
