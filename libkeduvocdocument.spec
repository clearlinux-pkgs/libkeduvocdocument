...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/libkeduvocdocument-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/libkeduvocdocument-23.08.4.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-23.08.4
cd %{_builddir}/libkeduvocdocument-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702931775
mkdir -p clr-build
pushd clr-build
