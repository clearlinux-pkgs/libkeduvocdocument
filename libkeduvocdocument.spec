...
Version  : 18.12.3
Release  : 3
URL      : https://download.kde.org/stable/applications/18.12.3/src/libkeduvocdocument-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/libkeduvocdocument-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/libkeduvocdocument-18.12.3.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-18.12.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1552010381
mkdir -p clr-build
pushd clr-build
