...
Version  : 19.12.1
Release  : 15
URL      : https://download.kde.org/stable/release-service/19.12.1/src/libkeduvocdocument-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/libkeduvocdocument-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/libkeduvocdocument-19.12.1.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-19.12.1
cd %{_builddir}/libkeduvocdocument-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578684022
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkeduvocdocument-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/libkeduvocdocument/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libkeduvocdocument-19.12.1/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libkeduvocdocument/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/libkeduvocdocument-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkeduvocdocument/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
