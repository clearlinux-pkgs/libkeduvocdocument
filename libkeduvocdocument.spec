...
Version  : 22.12.2
Release  : 48
URL      : https://download.kde.org/stable/release-service/22.12.2/src/libkeduvocdocument-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/libkeduvocdocument-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/libkeduvocdocument-22.12.2.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-22.12.2
cd %{_builddir}/libkeduvocdocument-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675639372
mkdir -p clr-build
pushd clr-build
