...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/libkeduvocdocument-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/libkeduvocdocument-23.08.5.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-23.08.5
cd %{_builddir}/libkeduvocdocument-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708376028
mkdir -p clr-build
pushd clr-build
