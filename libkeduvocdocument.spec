...
Version  : 24.05.0
Release  : 67
URL      : https://download.kde.org/stable/release-service/24.05.0/src/libkeduvocdocument-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/libkeduvocdocument-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/libkeduvocdocument-24.05.0.tar.xz.sig
...
%setup -q -n libkeduvocdocument-24.05.0
cd %{_builddir}/libkeduvocdocument-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716481007
mkdir -p clr-build
pushd clr-build
