...
Version  : 19.04.1
Release  : 7
URL      : https://download.kde.org/stable/applications/19.04.1/src/libkeduvocdocument-19.04.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.1/src/libkeduvocdocument-19.04.1.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.1/src/libkeduvocdocument-19.04.1.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-19.04.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1557458509
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
