...
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/libkeduvocdocument-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/libkeduvocdocument-22.08.3.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-22.08.3
cd %{_builddir}/libkeduvocdocument-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667857503
mkdir -p clr-build
pushd clr-build
