...
Version  : 23.04.3
Release  : 55
URL      : https://download.kde.org/stable/release-service/23.04.3/src/libkeduvocdocument-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/libkeduvocdocument-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/libkeduvocdocument-23.04.3.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-23.04.3
cd %{_builddir}/libkeduvocdocument-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688838746
mkdir -p clr-build
pushd clr-build
