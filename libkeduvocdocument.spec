...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/libkeduvocdocument-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/libkeduvocdocument-22.12.0.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-22.12.0
cd %{_builddir}/libkeduvocdocument-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670512979
mkdir -p clr-build
pushd clr-build
