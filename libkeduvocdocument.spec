...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/libkeduvocdocument-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/libkeduvocdocument-24.12.3.tar.xz.sig
...
%setup -q -n libkeduvocdocument-24.12.3
cd %{_builddir}/libkeduvocdocument-24.12.3
pushd ..
cp -a libkeduvocdocument-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742428304
mkdir -p clr-build
pushd clr-build
