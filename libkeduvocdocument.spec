...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/libkeduvocdocument-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/libkeduvocdocument-22.12.1.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-22.12.1
cd %{_builddir}/libkeduvocdocument-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673282086
mkdir -p clr-build
pushd clr-build
