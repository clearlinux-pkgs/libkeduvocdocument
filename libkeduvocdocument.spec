...
Version  : 22.08.1
Release  : 43
URL      : https://download.kde.org/stable/release-service/22.08.1/src/libkeduvocdocument-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/libkeduvocdocument-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/libkeduvocdocument-22.08.1.tar.xz.sig
...
%prep
%setup -q -n libkeduvocdocument-22.08.1
cd %{_builddir}/libkeduvocdocument-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662758429
mkdir -p clr-build
pushd clr-build
